...
def analyze_exoplanet():
    ...
    if file:
        try:
            ...
            expected_features = [
                'OrbitalPerioddays',
                'OrbitalPeriodUpperUncdays',
                'OrbitalPeriodLowerUncdays',
                'TransitEpochBKJD',
                'TransitEpochUpperUncBKJD',
                'TransitEpochLowerUncBKJD',
                'ImpactParamete',
                'ImpactParameterUpperUnc',
                'ImpactParameterLowerUnc',
                'TransitDurationhrs',
                'TransitDurationUpperUnchrs',
                'TransitDurationLowerUnchrs',
                'TransitDepthppm',
                'TransitDepthUpperUncppm',
                'TransitDepthLowerUncppm',
                'PlanetaryRadiusEarthradii',
                'PlanetaryRadiusUpperUncEarthradii',
                'PlanetaryRadiusLowerUncEarthradii',
                'EquilibriumTemperatureK',
                'InsolationFluxEarthflux',
                'InsolationFluxUpperUncEarthflux',
                'InsolationFluxLowerUncEarthflux',
                ...
                'StellarSurfaceGravitylog10(cm/s**2)',
                'StellarSurfaceGravityUpperUnclog10(cm/s**2)',
                'StellarSurfaceGravityLowerUnclog10(cm/s**2)',
                'StellarRadiusSolarradii',
                'StellarRadiusUpperUncSolarradii',
                'StellarRadiusLowerUncSolarradii',
                'RAdecimaldegrees',
                'Decdecimaldegrees',
                'Kepler-bandmag'
            ]
